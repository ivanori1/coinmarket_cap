...
global_url = base_url + 'global/?convert=' + convert
...
while True:
    print()
    print('Coin Market Cap Explorer menu')
    print('The global market cap is $' + global_cap_string)
    print()
    print('1 - Top 100 sorted by rank')
    print('2 - Top 100 sorted by 24 hours change')
    print('3 - Top 100 sorted by 24 h volume')
    print('0 - Exit')

    choice = input("What is your input? (0 or 1-3)")
    ticker_url = base_url + 'ticker/?structure=array&sort='
    if choice ==1:
        ticker_url +='rank'
    if choice ==2:
